...
def search_windows(img, windows, clf, scaler, color_space='YCrCb',
    ...
    for window in windows:
        ...
        features = lib.extract_features_from_single_image(
            test_img, spatial_feat, spatial_size, hist_feat, hist_bins, hog_feat, hog_channel, orient, pix_per_cell, cell_per_block)
...
def find_cars(img, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
    ...
    for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            # Get color features
            spatial_features = lib.bin_spatial(subimg, size=spatial_size)
            hist_features = lib.color_hist(subimg, nbins=hist_bins)
